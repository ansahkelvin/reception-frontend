...
import {MdAddHomeWork, MdOutlineWorkOutline, MdPeopleOutline, MdPersonOutline} from "react-icons/md";
    ...
    const links = [
        {
            ...
            active: location === '/human-resource/dashboard',
            icon: BiBarChart
        },
        {
            title: "Guests",
            url: '/human-resource',
            active: location === '/human-resource',
            icon: MdPersonOutline
        },
        {
            title: "Employees",
            url: '/human-resource/employee',
            active: location === '/human-resource/employee',
            icon: MdPeopleOutline
        },

        {
            title: "Departments",
            url: '/human-resource/departments',
            active: location === '/human-resource/departments',
